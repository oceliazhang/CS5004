public class Bishop implements ChessPiece{
    ...
    /**
     * Construct a Bishop object using the given row, column, color
     * @param row the row where locate the Bishop
     * @param column the column where locate the Bishop
     ...
     * @return the color the chess piece
     */
    @Override
